export default async function handler(req, res) {
    ...
    try {
        ...
        `;
            ...
            const response = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-3.5-flash:generateContent?key=${API_KEY}`, {            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
