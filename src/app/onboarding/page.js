...
export default function Onboarding() {
  ...
  const handleLockProfile = async () => {
    ...
    if (userRole === "examiner" && !identifier.trim()) {
      setError("Institution/College name is required for Examiners.");
      return;
    }
    ...
    try {
      ...
      if (userRole === "student") {
        ...
        updateData.examinerId =
          "EXT-" + Math.random().toString(36).substring(2, 6).toUpperCase();
      }

      await update(ref(database, `users/${currentUser.uid}`), updateData);
      window.location.href =
        userRole === "student" ? "/student-dashboard" : "/tests";
    } catch (err) {
    ...
    >
      ...
      >
        <i
          ...
          style={{ fontSize: "56px", color: "#185FA5", marginBottom: "1rem" }}
        ></i>
        ...
        >
          Welcome to ExamiTop. Please confirm your official details below.{" "}
          <br />
          <strong style={{ color: "#A32D2D" }}>
            Warning: This action is irreversible.
          </strong>{" "}
          The name provided here will be permanently printed on your exams and
          certificates.
        </p>
        ...
        <div style={{ textAlign: "left", marginBottom: "1.5rem" }}>
          ...
          >
            Official Full Name (As per records){" "}
        ...
        <div style={{ textAlign: "left", marginBottom: "2.5rem" }}>
          ...
          <input
            ...
            placeholder={
              userRole === "student" ? "e.g. 2024CS001" : "e.g. UIET Kanpur"
            }
            style={{
              width: "100%",
              padding: "12px",
              ...
              fontSize: "16px",
              marginTop: "6px",
              textTransform: userRole === "student" ? "uppercase" : "none",
            }}
          />
        </div>
        ...
        <button
          ...
          disabled={isSaving}
        >
          {isSaving ? "SECURING IDENTITY..." : "LOCK MY PROFILE"}{" "}
