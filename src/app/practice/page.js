...
export default function PracticeArena() {
  ...
  const fetchQuestion = async () => {
    ...
    try {
      ...
      setError(
        "Failed to fetch question. Please check your internet or API connection.",
      );
    } finally {
      setLoading(false);
    }
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <i className="ti ti-flame" style={{ color: "#e63946" }}></i> Practice
          Arena
        </h1>
        <p
          style={{
        ...
        >
          Endless questions to sharpen your brain. Stateless engine, zero data
          saved!
        </p>
      </div>
      ...
      <div
        className="card"
        style={{
          boxShadow: "0 10px 30px rgba(24, 95, 165, 0.08)",
          borderRadius: "16px",
          padding: "25px",
      ...
      >
        <div style={{ marginBottom: "1.5rem" }}>
          ...
          >
            <option value="general">
              🌍 General Knowledge & Trivia (Global)
            </option>
            <option value="exam">
              🎓 Competitive Exams & College (AI Powered)
            </option>
          </select>
        </div>
        ...
        {mode === "exam" && (
          ...
          >
            ...
            <div>
              ...
              >
                Specific Topic / Chapter (Required)
              </label>
              <input
                type="text"
                className="input-block"
                ...
                placeholder="e.g., Kinematics or Operating Systems"
                value={chapter}
        ...
        >
          {loading ? (
            ...
            <>
              <i
                className={`ti ${mode === "exam" ? "ti-wand" : "ti-player-play"}`}
              ></i>{" "}
              {mode === "exam" ? "Generate AI Question" : "Start Random Trivia"}
            </>
          )}
        </button>
      </div>
      ...
      {qData && (
        <div
          ...
          style={{
            padding: "2rem",
            borderTop: `4px solid ${qData.source === "gemini" ? "#534AB7" : "#3B6D11"}`,
            borderRadius: "16px",
            ...
            {qData.source === "gemini" ? (
              ...
              <>
                <span className="badge b-gray">
                  <i className="ti ti-category"></i> {qData.category}
                </span>
                <span
                  className="badge"
                  style={{
          ...
          >
            {qData.options.map((opt, idx) => {
              ...
              let btnStyle = {
                ...
                opacity:
                  selectedOpt !== null && !isSelected && !isCorrect ? 0.6 : 1,
              };
              ...
              return (
                <button
                  ...
                  style={btnStyle}
                  onClick={() => {
                    if (selectedOpt === null) setSelectedOpt(idx);
                  }}
          ...
          {selectedOpt !== null && (
            <div
              style={{
                marginTop: "20px",
                padding: "18px",
                background: qData.source === "gemini" ? "#EEEDFE" : "#f8fafc",
                borderLeft: `5px solid ${qData.source === "gemini" ? "#534AB7" : "#cbd5e1"}`,
                borderRadius: "10px",
            ...
            >
              <h4
                style={{
                  color: qData.source === "gemini" ? "#3C3489" : "#0f172a",
                  margin: "0 0 10px 0",
                  fontSize: "15px",
                  display: "flex",
                  alignItems: "center",
