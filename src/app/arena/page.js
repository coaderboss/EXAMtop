    ...
    return (
      <div style={{ textAlign: "center", padding: "4rem" }}>
        <i
          ...
          style={{ fontSize: "48px", color: "#64748b", marginBottom: "1rem" }}
        ></i>
        <h3>Please Login</h3>
        <p>You need to log in to access the Practice Arena.</p>
      </div>
    );
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Test your knowledge, improve your logical building, and prepare for
          exams using our vast general database or custom AI-generated mock
          tests.
        </p>
      </div>
      ...
      >
        <button
          ...
          style={{
            ...
            fontWeight: 700,
            borderRadius: "30px",
            background: activeTab === "general" ? "#185FA5" : "#fff",
            color: activeTab === "general" ? "#fff" : "#64748b",
            border: activeTab === "general" ? "none" : "2px solid #e2e8f0",
            boxShadow:
              activeTab === "general"
                ? "0 10px 20px rgba(24,95,165,0.2)"
                : "none",
          }}
          ...
          style={{
            ...
            background:
              activeTab === "gemini"
                ...
                : "#fff",
            color: activeTab === "gemini" ? "#fff" : "#64748b",
            border: activeTab === "gemini" ? "none" : "2px solid #e2e8f0",
            boxShadow:
              activeTab === "gemini"
      ...
      {activeTab === "general" && (
        <div
          className="card"
          style={{ padding: "3rem 2rem", border: "1px solid #e2e8f0" }}
        >
          {!genQ && !genLoading && !genError && (
            <div style={{ textAlign: "center" }}>
              ...
              >
                Global Random Trivia
              </h2>
              <p style={{ color: "#64748b", marginBottom: "2.5rem" }}>
                Fetch a random challenging question from the global database.
              </p>
              <button
          ...
          {genQ && !genLoading && (
            ...
            >
              ...
              >
                ...
                >
                  <i className="ti ti-category"></i> {genQ.category}
                </span>
                <span
                  className="badge"
                  style={{
              ...
              >
                {genOptions.map((opt, i) => {
                  ...
                  let btnStyle = {
                    ...
                    background: "#fff",
                    cursor: genSelected ? "default" : "pointer",
                    transition: "0.2s",
                    width: "100%",
                    color: "#1e293b",
                  };
                  ...
                  if (genSelected !== null) {
                    if (isCorrect) {
                      btnStyle.background = "#EAF3DE";
                      btnStyle.borderColor = "#3B6D11";
                      btnStyle.color = "#27500A";
                    } else if (isSelected && !isCorrect) {
                      btnStyle.background = "#FCEBEB";
                      btnStyle.borderColor = "#A32D2D";
                      btnStyle.color = "#791F1F";
                    } else {
                    ...
                    >
                      ...
                      {genSelected !== null && isCorrect && (
                        <i
                          ...
                          style={{ fontSize: "24px", color: "#3B6D11" }}
                        ></i>
                      )}
                      {genSelected !== null && isSelected && !isCorrect && (
                        <i
                          className="ti ti-x"
                          style={{ fontSize: "24px", color: "#A32D2D" }}
                        ></i>
                      )}
                    </button>
                  );
        ...
        >
          {!gemQ && !gemLoading && (
            ...
            >
              ...
              >
                Type any engineering topic, algorithm, or concept. Our AI will
                instantly curate a challenging question with a step-by-step
                solution.
              </p>
          ...
          {gemLoading && (
            <div style={{ textAlign: "center", padding: "4rem 0" }}>
              ...
              ></div>
              <h3 style={{ color: "#064e3b", marginTop: "1.5rem" }}>
                AI is crafting a unique question...
              </h3>
          ...
          {gemError && (
            ...
            >
              ...
              ></i>
              <h3 style={{ color: "#A32D2D", margin: "0 0 10px 0" }}>
                Generation Failed
              </h3>
              <p style={{ color: "#791F1F", marginBottom: "1.5rem" }}>
                {gemError}
              </p>
              <button
                className="btn btn-danger"
          ...
          {gemQ && !gemLoading && (
            ...
            >
              ...
              >
                ...
                >
                  <i className="ti ti-wand"></i> AI Generated
                </span>
                <span className="badge b-blue" style={{ padding: "6px 12px" }}>
              ...
              >
                {gemQ.options.map((opt, i) => {
                  ...
                  let btnStyle = {
                    ...
                    border: "2px solid #e2e8f0",
                    background: "#fff",
                    cursor: gemSelected !== null ? "default" : "pointer",
                    transition: "0.2s",
                    width: "100%",
                    color: "#1e293b",
                  };
