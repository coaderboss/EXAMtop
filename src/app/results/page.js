...
export default function GlobalResults() {
  ...
  if (authLoading || loadingData) {
    return (
      <div className="spinner-container" style={{ paddingTop: "10vh" }}>
        ...
        <div>Loading Global Database...</div>
      </div>
    );
  }
    ...
    return (
      <div style={{ textAlign: "center", padding: "4rem" }}>
        <i
          ...
          style={{ fontSize: "48px", color: "#A32D2D", marginBottom: "1rem" }}
        ></i>
        <h3>Access Denied</h3>
  ...
  const exportLeaderboard = () => {
    ...
    let csv =
      "Rank,Student Name,Roll Number,Total Score,Accuracy (%),Submission Time\n";

    const sortedSubs = [...searchedTest.submissions].sort(
    ...
    >
      <div className="page-header">
        ...
        <div className="page-sub">
          Search across the entire platform using a Test Code to view rankings.
        </div>
      </div>
      ...
      >
        ...
        ></i>
        <h3
          style={{ marginBottom: "1.5rem", color: "var(--color-text-primary)" }}
        >
          Enter Test Code
        </h3>
        ...
        <div className="card" style={{ padding: "2rem" }}>
          ...
          >
            <div>
              ...
              >
                Max Marks: {searchedTest.totalMarks || 0} &bull; Total
                Submissions: {searchedTest.submissions?.length || 0}
              </div>
            </div>
            <button
              className="btn btn-success"
              onClick={exportLeaderboard}
              disabled={!searchedTest.submissions?.length}
            >
              <i className="ti ti-download"></i> Download Leaderboard
            </button>
          </div>

          {!searchedTest.submissions ||
          searchedTest.submissions.length === 0 ? (
            <div
              style={{
                textAlign: "center",
                padding: "2rem",
            ...
            >
              No data available to generate a leaderboard.
            </div>
          ) : (
