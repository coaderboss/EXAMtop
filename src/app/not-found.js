    ...
    <div className="flex flex-col items-center justify-center min-h-[85vh] bg-slate-50 px-6 text-center overflow-hidden">
      ...
      <div className="relative mb-2 animate-[floatUFO_4s_ease-in-out_infinite]">
        ...
        <div className="relative z-10 w-36 h-36 bg-white rounded-full border-[6px] border-slate-100 shadow-[0_15px_35px_rgba(0,0,0,0.1)] flex flex-col items-center justify-center overflow-hidden">
          ...
          <span className="text-5xl font-black text-slate-800 drop-shadow-sm relative z-10 tracking-tighter">
            404
          </span>
        ...
        <div
          className="absolute top-1/2 left-1/2 w-[220px] h-[220px] border-4 border-blue-400 rounded-full opacity-40 animate-[ringSpin_3s_linear_infinite]"
          style={{ transformStyle: "preserve-3d" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 w-[240px] h-[240px] border-[3px] border-dashed border-indigo-400 rounded-full opacity-30 animate-[ringSpin_6s_linear_infinite_reverse]"
          style={{ transformStyle: "preserve-3d" }}
        ></div>
      </div>
      ...
      <p className="text-slate-500 text-sm sm:text-[15px] font-medium max-w-md mb-8 leading-relaxed">
        Houston, we have a problem. You've wandered into the Bermuda Triangle of
        this portal. This page either evaporated or the dog ate its source code.
      </p>

      {/* Action Button */}
      <Link
        href="/"
        className="px-6 py-3.5 bg-blue-600 hover:bg-blue-700 text-white font-bold text-[15px] rounded-xl shadow-[0_8px_20px_rgba(37,99,235,0.25)] hover:shadow-[0_12px_25px_rgba(37,99,235,0.4)] hover:-translate-y-1 transition-all flex items-center gap-2 group"
      >
        <i className="ti ti-rocket text-xl group-hover:-translate-y-1 transition-transform"></i>{" "}
