...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    return () =>
      document.removeEventListener("click", handleGlobalLoginClick, true);
  }, []);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50">
        <motion.div
          ...
          className="w-12 h-12 border-[3px] border-[#185FA5] border-t-transparent rounded-full"
        ></motion.div>
      </div>
    );
    ...
    <div className="min-h-screen bg-white text-slate-800 font-sans overflow-x-clip selection:bg-[#185FA5] selection:text-white">
      ...
      <section className="relative min-h-[95vh] flex flex-col justify-center items-center text-center px-4 md:px-6 overflow-hidden bg-slate-50">
        ...
        <motion.div
          ...
          className="absolute top-[10%] left-[15%] w-[400px] h-[400px] md:w-[500px] md:h-[500px] bg-[#185FA5] rounded-full mix-blend-multiply filter blur-[90px] opacity-[0.15] pointer-events-none z-0"
        ></motion.div>

        <motion.div
          animate={{ x: [0, -50, 0], y: [0, 60, 0] }}
          transition={{ repeat: Infinity, duration: 15, ease: "easeInOut" }}
          className="absolute bottom-[10%] right-[15%] w-[350px] h-[350px] md:w-[450px] md:h-[450px] bg-[#8B0000] rounded-full mix-blend-multiply filter blur-[90px] opacity-[0.12] pointer-events-none z-0"
        ></motion.div>
        ...
        <div className="absolute inset-0 pointer-events-none z-20 flex justify-center items-center perspective-[1200px] overflow-hidden">
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              <div className="w-10 h-10 rounded-xl bg-blue-50 flex items-center justify-center text-blue-600 shadow-sm border border-blue-200">
                <i className="ti ti-math-function text-xl"></i>
              </div>
              <div className="text-[10px] md:text-xs font-black text-slate-800 uppercase tracking-widest">
                Math Engine
              </div>
            </div>
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-xl bg-red-50 flex items-center justify-center text-red-600 shadow-sm border border-red-200">
                <i className="ti ti-shield-lock text-xl"></i>
              </div>
              <div className="text-[10px] md:text-xs font-black text-slate-800 uppercase tracking-widest">
                Proctor AI
              </div>
            ...
            <div className="flex items-center gap-3 bg-slate-50/80 p-2.5 rounded-xl border border-slate-200">
              ...
              <div className="text-[9px] md:text-[10px] font-black text-slate-600 uppercase tracking-widest">
                Monitoring Sync
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="text-[10px] font-black text-slate-500 mt-3 uppercase text-center tracking-widest">
              O(1) Evaluation
            </div>
          </motion.div>
        ...
        <motion.div
          ...
          className="max-w-5xl z-20 pt-16 relative"
        >
          <motion.div
            variants={heroReveal}
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-slate-200 bg-white/90 backdrop-blur-md text-[#185FA5] font-black text-[11px] tracking-widest uppercase mb-10 shadow-[0_8px_20px_rgba(24,95,165,0.08)]"
          >
          ...
          <motion.h1
            variants={heroReveal}
            className="text-5xl md:text-8xl lg:text-[90px] font-black tracking-tight text-[#0f172a] mb-8 leading-[1.05]"
          >
          ...
          <motion.p
            variants={heroReveal}
            className="text-lg md:text-xl text-slate-500 mb-12 max-w-3xl mx-auto font-medium leading-relaxed px-2"
          >
            A military-grade evaluation framework built for scale. Featuring
            synchronous MathJax rendering, absolute scoring precision, and a
            pure offline operational mode.
          </motion.p>

          <motion.div
            variants={heroReveal}
            className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto relative z-30"
          >
            <motion.button
              ...
              className="w-full sm:w-auto px-10 py-4 md:py-5 bg-[#185FA5] hover:bg-[#0C447C] text-white rounded-2xl font-black text-[15px] transition-all flex items-center justify-center gap-3 shadow-[0_10px_30px_rgba(24,95,165,0.25)]"
            >
            ...
            <motion.button
              ...
              className="w-full sm:w-auto px-10 py-4 md:py-5 bg-white/95 backdrop-blur-md text-[#854F0B] border-2 border-[#FAC775] hover:bg-[#fffcf7] rounded-2xl font-black text-[15px] transition-all flex items-center justify-center gap-3 shadow-[0_8px_25px_rgba(0,0,0,0.04)]"
            >
      ...
      <section className="py-24 md:py-32 px-6 border-y border-slate-200 bg-white relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-[#8B0000] text-xs font-black tracking-[0.2em] uppercase mb-4">
              Core Infrastructure
            </h2>
            <h3 className="text-4xl md:text-5xl font-black text-[#0f172a] tracking-tight mb-6">
              Engineered for Reliability.
            </h3>
            <p className="text-lg text-slate-500 max-w-2xl mx-auto font-medium">
              We discarded legacy frameworks to build a platform that respects
              both the examiner's intent and the student's focus.
            </p>
          </motion.div>
          ...
          >
            {[
              {
                title: "Zero-Flicker MathJax",
                icon: "ti-math-function",
                color: "text-[#185FA5]",
                bg: "bg-blue-50",
                border: "border-blue-100",
                desc: "Synchronous rendering pipeline ensures complex LaTeX and AsciiMath load instantly without layout shifts or DOM flashing.",
              },
              {
                title: "Proctor Sentinel",
                icon: "ti-shield-lock",
                color: "text-[#8B0000]",
                bg: "bg-red-50",
                border: "border-red-100",
                desc: "Background security daemon actively tracks tab-switches, blur events, and full-screen evasion with cryptographic logging.",
              },
              {
                ...
                desc: "Advanced O(n) evaluation logic calculates MSQ partial marks flawlessly and prevents notorious double-negative bugs.",
              },
            ].map((feature, i) => (
              <motion.div
                key={i}
                ...
                className="bg-slate-50 border border-slate-200 p-10 rounded-[32px] shadow-sm hover:shadow-2xl transition-all duration-300 flex flex-col items-start text-left"
              >
                <div
                  className={`w-16 h-16 rounded-2xl ${feature.bg} ${feature.border} border flex items-center justify-center text-3xl mb-8 ${feature.color} shadow-sm`}
                >
      ...
      <section className="py-24 md:py-32 px-6 bg-slate-50 border-b border-slate-200 overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16 lg:gap-24">
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: "-100px" }}
            variants={flipUp}
            className="flex-1 w-full relative perspective-[1200px] flex flex-col gap-4 md:gap-6 z-10"
          >
            ...
            <div className="bg-white border border-slate-200 rounded-[24px] overflow-hidden shadow-[0_30px_60px_rgba(0,0,0,0.06)] transform-gpu rotate-y-[-2deg] rotate-x-[2deg] relative z-20">
              ...
              <div className="bg-slate-100 px-5 md:px-6 py-4 border-b border-slate-200 flex justify-between items-center">
                <div className="font-black text-slate-800 flex items-center gap-2 text-sm md:text-base">
                  <i className="ti ti-folder-star text-[#8B0000] text-xl"></i>{" "}
                  My Test Vault
                </div>
              ...
              <div className="p-5 md:p-6 space-y-4 bg-white">
                ...
                <div className="p-4 md:p-4.5 rounded-2xl border-2 border-[#10B981]/30 bg-[#10B981]/5 flex justify-between items-center transition-all hover:shadow-md">
                  <div>
                    <div className="font-black text-slate-900 text-[14px] md:text-[15px] mb-1">
                      JEE Advanced Physics - Mock 1
                    </div>
                    <div className="text-[10px] md:text-[11px] font-bold font-mono text-slate-500">
                      CODE:{" "}
                      <span className="text-[#8B0000] tracking-widest">
                        PHY-X9
                      </span>{" "}
                      &bull; 75 Marks
                    </div>
                  ...
                  <div className="flex flex-col items-end gap-1.5 shrink-0">
                    ...
                    <span className="text-[8px] md:text-[9px] font-black text-[#10B981] uppercase tracking-widest">
                      Radar On
                    </span>
                  </div>
                </div>
            ...
            <div className="bg-white border border-slate-200 rounded-[24px] overflow-hidden shadow-[0_20px_50px_rgba(24,95,165,0.12)] transform-gpu rotate-y-[2deg] rotate-x-[2deg] ml-0 md:ml-12 border-t-4 border-t-[#185FA5] relative z-20">
              <div className="bg-[#f0f7ff] px-5 md:px-6 py-3 border-b border-slate-200 flex justify-between items-center">
                <div className="font-black text-slate-800 flex items-center gap-2 text-sm">
                  <i className="ti ti-radar text-[#185FA5] text-lg animate-pulse"></i>{" "}
                  Student Radar
                </div>
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-black text-[#0f172a] tracking-tight mb-6 leading-tight">
              Command your <br />
              assessment ecosystem.
            </h2>
            <p className="text-lg text-slate-500 mb-8 leading-relaxed font-semibold">
              Designed for educators who demand absolute control. Build
              precision tests and manage distribution directly to your
              following.
            </p>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4 p-4 rounded-2xl hover:bg-white border border-transparent hover:border-slate-200 transition-all shadow-sm">
                <div className="w-10 h-10 rounded-full bg-[#185FA5]/10 flex items-center justify-center text-[#185FA5] shrink-0 font-black">
                  <i className="ti ti-math-symbols"></i>
                </div>
                <div>
                  <h4 className="font-black text-slate-900 text-lg mb-1">
                    Dynamic Test Forging
                  </h4>
                  <p className="text-[14px] text-slate-500 font-medium leading-relaxed">
                    Create rigorous exams supporting MCQ, MSQ, and custom
                    negative marking logic, fully compatible with LaTeX inputs.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-4 rounded-2xl hover:bg-white border border-transparent hover:border-slate-200 transition-all shadow-sm">
                ...
                <div>
                  <h4 className="font-black text-slate-900 text-lg mb-1">
                    Targeted Radar Deployment
                  </h4>
                  <p className="text-[14px] text-slate-500 font-medium leading-relaxed">
                    Instantly push active assessments to your followers'
                    dashboards with a single toggle, or keep them strictly
                    private via unique codes.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-4 rounded-2xl hover:bg-white border border-transparent hover:border-slate-200 transition-all shadow-sm">
                ...
                <div>
                  <h4 className="font-black text-slate-900 text-lg mb-1">
                    Actionable Proctor Audits
                  </h4>
                  <p className="text-[14px] text-slate-500 font-medium leading-relaxed">
                    Review cryptographically signed cheat logs detailing exact
                    timestamps of tab-switches and window blur events.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-24 md:py-32 px-6 bg-white relative">
        <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center gap-16 lg:gap-24">
          ...
          >
            ...
            <p className="text-lg text-slate-500 mb-8 leading-relaxed font-semibold">
              Built to mimic high-stakes national-level competitive testing
              environments. Zero distractions, 100% focus.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex gap-4 p-4 rounded-2xl hover:bg-slate-50 border border-transparent hover:border-slate-200 transition-all shadow-sm">
                <div className="w-10 h-10 rounded-full bg-[#8B0000]/10 flex items-center justify-center text-[#8B0000] shrink-0 font-black">
                ...
                <div>
                  ...
                  <p className="text-[15px] text-slate-500 font-medium">
                    Long questions and the navigation palette scroll
                    independently, ensuring UI stability during intense
                    calculations.
                  </p>
                </div>
              </div>
              <div className="flex gap-4 p-4 rounded-2xl hover:bg-slate-50 border border-transparent hover:border-slate-200 transition-all shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-[15px] text-slate-500 font-medium">
                    Browser crash? Network drop? Answers are continuously
                    encrypted in local memory and auto-synced upon reconnection.
                  </p>
                </div>
              </div>
            </div>
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: "-100px" }}
            variants={flipUp}
            className="flex-1 w-full relative perspective-[1200px]"
          >
                ...
                <div className="flex-1 p-8 border-r border-slate-200 flex flex-col relative bg-white">
                  ...
                  <div className="space-y-4">
                    {[1, 2, 3, 4].map((n) => (
                      <div
                        key={n}
                        className={`w-full h-14 border rounded-xl flex items-center px-5 gap-4 ${n === 2 ? "border-blue-400 bg-blue-50/50" : "border-slate-200 bg-slate-50"}`}
                      >
                        <div
                          className={`w-6 h-6 rounded-md border-2 ${n === 2 ? "border-blue-500 bg-blue-500" : "border-slate-300"}`}
                        ></div>
                ...
                <div className="w-48 bg-slate-50 p-5 shrink-0 flex flex-col">
                  ...
                  <div className="grid grid-cols-4 gap-2">
                    {[...Array(16)].map((_, i) => (
                      <div
                        key={i}
                        className={`aspect-square rounded-md border-2 flex items-center justify-center text-[11px] font-black ${i === 3 ? "bg-[#185FA5] text-white border-[#185FA5] shadow-md" : i === 7 ? "bg-[#FAC775] border-[#FAC775] text-[#633806]" : "bg-white border-slate-200 text-slate-400"}`}
                      >
                        {i + 1}
                      </div>
                    ))}
      ...
      <section className="py-20 md:py-32 px-4 md:px-6 bg-slate-50 border-y border-slate-200 relative overflow-hidden z-0">
        ...
        <motion.div
          ...
          transition={{ repeat: Infinity, duration: 15, ease: "easeInOut" }}
          className="absolute top-[10%] right-[10%] w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-[#185FA5] rounded-full mix-blend-multiply filter blur-[100px] md:blur-[140px] opacity-[0.06] pointer-events-none -z-20"
        ></motion.div>
        <motion.div
          animate={{ x: [0, 30, 0], y: [0, -40, 0] }}
          transition={{ repeat: Infinity, duration: 18, ease: "easeInOut" }}
          className="absolute bottom-[5%] left-[5%] w-[400px] md:w-[700px] h-[400px] md:h-[700px] bg-[#D4AF37] rounded-full mix-blend-multiply filter blur-[100px] md:blur-[150px] opacity-[0.05] pointer-events-none -z-20"
        ></motion.div>
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          <motion.div
            ...
            variants={fadeUp}
          >
            <h2 className="text-[#185FA5] text-[11px] md:text-xs font-black tracking-[0.2em] uppercase mb-3 md:mb-4 bg-[#185FA5]/10 text-[#185FA5] inline-block px-4 py-1.5 rounded-full border border-[#185FA5]/20 shadow-sm">
              Live Interface
            </h2>
            <h3 className="text-3xl md:text-5xl font-black text-[#0f172a] tracking-tight mb-5 md:mb-6">
              Experience the Sandbox.
            </h3>
            <p className="text-base md:text-lg text-slate-500 mb-12 md:mb-16 font-medium max-w-2xl mx-auto px-2">
              A functional replica of the evaluation screen. Clean separation of
              active questions and navigation palette.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: "-50px" }}
            variants={flipUp}
            className="bg-white/95 backdrop-blur-xl rounded-[20px] md:rounded-[32px] overflow-hidden shadow-[0_20px_60px_rgba(24,95,165,0.12)] border border-white text-left mx-auto max-w-[1000px] flex flex-col h-[500px] md:h-[550px] ring-1 ring-slate-900/5"
          >
            {/* Brand Header */}
            <div className="bg-[#185FA5] border-b border-[#0C447C] text-white px-5 md:px-6 py-4 flex justify-between items-center shrink-0">
              <div className="min-w-0">
                <div className="font-black text-base md:text-lg leading-tight tracking-wide truncate">
                  National Assessment Module
                </div>
                <div className="text-[10px] md:text-[11px] text-blue-200 font-mono mt-0.5 font-bold truncate">
                  UID: EXM-9921 &bull; Q 4 / 75
                </div>
              </div>
              <div className="bg-[#0C447C] border border-[#1a6ebd] px-3 md:px-4 py-1.5 md:py-2 rounded-lg font-mono font-black text-xs md:text-sm flex items-center gap-2 shadow-inner text-white shrink-0">
                <i className="ti ti-clock text-base"></i>{" "}
                <span className="hidden sm:inline">02:45:10</span>
              </div>
            </div>
            ...
            <div className="flex flex-1 overflow-hidden bg-white">
              ...
              <div className="flex-1 p-5 md:p-8 flex flex-col border-r border-slate-100 relative bg-white">
                <div className="flex justify-between items-start mb-6 md:mb-8 border-b border-slate-100 pb-4 md:pb-5">
                  <div className="flex items-center gap-3 md:gap-4">
                    <div className="w-10 h-10 md:w-12 md:h-12 bg-slate-50 text-[#185FA5] rounded-xl flex items-center justify-center font-black text-lg md:text-xl border border-slate-200 shadow-sm">
                      4
                    </div>
                    <span className="bg-blue-50 text-[#185FA5] border border-blue-100 text-[10px] md:text-xs font-black px-2.5 md:px-3 py-1 md:py-1.5 rounded-md uppercase tracking-widest">
                      Single Correct
                    </span>
                  </div>
                  <span className="text-xs md:text-sm font-black text-slate-500 bg-slate-50 border border-slate-200 px-3 md:px-4 py-1.5 md:py-2 rounded-lg shrink-0">
                    4 Marks
                  </span>
                </div>

                <div className="text-slate-800 font-bold mb-8 md:mb-10 text-[15px] md:text-lg leading-relaxed">
                  Evaluate the integral and select the correct physical
                  interpretation of the resulting matrix transformation in a 3D
                  coordinate space.
                </div>
                ...
                <div className="space-y-3 md:space-y-4 max-h-full overflow-y-auto custom-scrollbar pb-16">
                  {[
                    ...
                    "B. Identity Matrix Scaling",
                    "C. Non-linear Rotation",
                    "D. Zero Determinant Collapse",
                  ].map((opt, i) => (
                    <div
                      key={i}
                      className={`p-3.5 md:p-4 rounded-xl md:rounded-2xl flex items-center gap-4 md:gap-5 cursor-pointer transition-all border-2 ${i === 1 ? "border-[#185FA5] bg-[#185FA5]/5 shadow-sm" : "border-slate-100 bg-white hover:border-slate-200"}`}
                    >
                      <div
                        className={`w-7 h-7 md:w-8 md:h-8 rounded-lg flex items-center justify-center text-xs md:text-sm font-black shrink-0 ${i === 1 ? "bg-[#185FA5] text-white shadow-sm" : "bg-slate-100 text-slate-500"}`}
                      >
                        {i === 1 ? (
                      ...
                      <div
                        className={`font-black text-[13px] md:text-[15px] ${i === 1 ? "text-[#0f172a]" : "text-slate-600"}`}
                      >
                        {opt}
                      </div>
                    </div>
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 md:p-5 border-t border-slate-100 bg-white/95 backdrop-blur-md flex justify-between items-center px-5 md:px-8">
                  <button className="px-5 md:px-6 py-2.5 md:py-3 bg-slate-100 text-slate-600 font-black rounded-xl flex items-center gap-2 hover:bg-slate-200 transition-colors text-xs md:text-sm">
                    <i className="ti ti-arrow-left"></i> Prev
                  </button>
                  <button className="px-6 md:px-8 py-2.5 md:py-3 bg-[#185FA5] text-white font-black rounded-xl flex items-center gap-2 shadow-lg shadow-[#185FA5]/20 hover:bg-[#0C447C] transition-colors text-xs md:text-sm">
              ...
              <div className="w-[300px] md:w-[340px] bg-slate-50 p-6 md:p-8 shrink-0 hidden lg:flex flex-col">
                <div className="text-[12px] md:text-[13px] font-black text-slate-500 mb-5 md:mb-6 uppercase tracking-widest border-b border-slate-200 pb-3 md:pb-4">
                  Question Palette
                </div>
                ...
                <div className="flex flex-wrap gap-2 md:gap-2.5 mb-6 md:mb-8 bg-white p-3 md:p-4 rounded-xl md:rounded-2xl border border-slate-200 justify-center shadow-sm">
                  <div className="flex items-center gap-1.5 md:gap-2 text-[10px] md:text-[11px] font-black text-slate-700 uppercase tracking-wide">
                    <div className="w-3 h-3 md:w-3.5 md:h-3.5 rounded bg-white border-2 border-slate-300"></div>
                    Unvisited
                  </div>
                  <div className="flex items-center gap-1.5 md:gap-2 text-[10px] md:text-[11px] font-black text-slate-700 uppercase tracking-wide">
                    <div className="w-3 h-3 md:w-3.5 md:h-3.5 rounded bg-[#185FA5] shadow-sm"></div>
                    Answered
                  </div>
                  <div className="flex items-center gap-1.5 md:gap-2 text-[10px] md:text-[11px] font-black text-slate-700 uppercase tracking-wide">
                    <div className="w-3 h-3 md:w-3.5 md:h-3.5 rounded bg-[#FAC775] shadow-sm"></div>
                    Marked
                  </div>
                </div>
                ...
                <div className="grid grid-cols-5 gap-2 md:gap-3 mb-auto">
                  {[...Array(25)].map((_, i) => {
                    ...
                    if (n === 4)
                      bg =
                        "bg-white border-[#8B0000] text-[#8B0000] ring-4 ring-[#8B0000]/10 z-10 relative"; // Current
                    else if (n === 1 || n === 2)
                      bg = "bg-[#185FA5] border-[#185FA5] text-white shadow-sm"; // Answered
                    else if (n === 3 || n === 12)
                      bg =
                        "bg-[#FAC775] border-[#FAC775] text-[#633806] shadow-sm"; // Marked

                    return (
                      <div
                        key={n}
                        className={`aspect-square rounded-lg md:rounded-xl border-2 flex items-center justify-center text-[13px] md:text-[14px] font-black cursor-pointer transition-all ${bg}`}
                      >
                        {n}
                      </div>
                    );
      ...
      >
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            className="text-center mb-16 md:mb-24"
          >
            <h2 className="text-[#185FA5] text-xs font-black tracking-[0.2em] uppercase mb-4">
              Authentication
            </h2>
            <h3 className="text-4xl md:text-6xl font-black text-[#0f172a] tracking-tight mb-6">
              Mount the Terminal.
            </h3>
            <p className="text-lg text-slate-500 font-medium max-w-2xl mx-auto">
              Select your designated operational clearance below to initialize
              the system.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            ...
            <motion.div
              ...
              variants={cardPop}
              whileHover={{ y: -10 }}
              className="bg-white border-2 border-slate-100 rounded-[40px] shadow-[0_20px_60px_rgba(0,0,0,0.04)] hover:shadow-[0_30px_80px_rgba(139,0,0,0.1)] transition-all duration-500 overflow-hidden flex flex-col relative group"
            >
              ...
              <div className="p-10 md:p-12 flex flex-col h-full items-center text-center">
                ...
                <h3 className="text-3xl font-black text-[#0f172a] mb-4 tracking-tight">
                  Examiner Vault
                </h3>
                <p className="text-slate-500 mb-12 text-base md:text-lg font-medium leading-relaxed">
                  Access the command matrix. Design multi-format assessments,
                  configure penalty algorithms, and audit cryptographic cheat
                  logs.
                </p>
                <button
                  onClick={() => {
            ...
            <motion.div
              ...
              variants={cardPop}
              whileHover={{ y: -10 }}
              className="bg-white border-2 border-slate-100 rounded-[40px] shadow-[0_20px_60px_rgba(0,0,0,0.04)] hover:shadow-[0_30px_80px_rgba(24,95,165,0.1)] transition-all duration-500 overflow-hidden flex flex-col relative group"
            >
              ...
              <div className="p-10 md:p-12 flex flex-col h-full items-center text-center">
                ...
                <p className="text-slate-500 mb-12 text-base md:text-lg font-medium leading-relaxed">
                  Enter the secure execution sandbox. Engage with live radar
                  assessments, utilize flawless formula rendering, and track
                  performance.
                </p>
                <div className="mt-auto w-full flex flex-col sm:flex-row gap-4">
                  ...
                  <button
                    ...
                    className="w-full sm:w-auto px-10 py-5 bg-slate-50 border-2 border-slate-200 hover:bg-slate-100 text-slate-700 rounded-2xl font-black text-[16px] transition-all active:scale-95 shadow-sm"
                  >
                    Guest
                  </button>
                </div>
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-12 md:mb-16">
            ...
            <motion.div variants={fadeUp} className="col-span-2 lg:col-span-1">
              <div className="flex items-center gap-3 mb-5 md:mb-6">
                <div className="w-10 h-10 bg-[#185FA5] text-white rounded-xl flex items-center justify-center text-xl font-black shadow-lg shadow-[#185FA5]/20">
                  E
                </div>
              ...
              <p className="text-slate-400 text-sm leading-relaxed font-medium">
                The next-generation assessment engine built for scale,
                precision, and absolute integrity. Engineered to handle
                high-stakes evaluations flawlessly.
              </p>
            </motion.div>

            {/* Links 1 (Takes half width on mobile) */}
            <motion.div variants={fadeUp} className="col-span-1">
              <h4 className="text-white font-black uppercase tracking-widest text-[11px] md:text-xs mb-5 md:mb-6">
                Ecosystem
              </h4>
            ...
            <motion.div variants={fadeUp} className="col-span-2 lg:col-span-1">
              ...
              <ul className="space-y-4 md:space-y-5">
                <li className="flex items-start gap-3 group cursor-pointer">
                  <div className="w-8 h-8 rounded-lg bg-slate-800 flex items-center justify-center text-[#185FA5] shrink-0 group-hover:bg-[#185FA5] group-hover:text-white transition-colors">
          ...
          <motion.div
            variants={fadeUp}
            className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-5 text-center md:text-left"
          >
            <p className="text-slate-500 text-xs font-bold tracking-wide">
              &copy; {new Date().getFullYear()} EXAMITOP ENGINE. ALL RIGHTS
              RESERVED.
            </p>
            <div className="flex gap-3">
              <a
                href="#"
                className="w-10 h-10 rounded-xl bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-[#185FA5] hover:text-white hover:-translate-y-1 transition-all"
              >
                <i className="ti ti-brand-twitter text-lg"></i>
              </a>
              <a
                href="#"
                className="w-10 h-10 rounded-xl bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-[#185FA5] hover:text-white hover:-translate-y-1 transition-all"
      ...
      <AnimatePresence>
        {showOfflineModal && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[9999] flex items-center justify-center px-4 bg-slate-900/70 backdrop-blur-md"
          >
            <motion.div
              ...
              className="bg-white border-2 border-slate-200 rounded-[32px] w-full max-w-md shadow-2xl overflow-hidden perspective-[1000px]"
            >
              <div className="px-8 py-5 border-b border-slate-100 flex items-center justify-between bg-slate-50">
                <div className="text-xs font-black text-slate-500 flex items-center gap-2 uppercase tracking-widest">
                  <i className="ti ti-server-off text-[#854F0B] text-lg"></i>{" "}
                  Local Execution
                </div>
                <button
              ...
              <div className="p-8">
                ...
                <p className="text-slate-500 text-sm mb-8 font-medium leading-relaxed bg-amber-50 p-4 rounded-xl border border-amber-100 text-amber-900">
                  Data will be cryptographically written to this device's
                  IndexedDB.{" "}
                ...
                <div className="space-y-4">
                  <button
                    ...
                    className="w-full p-4 rounded-2xl bg-white hover:bg-slate-50 border-2 border-slate-100 hover:border-[#185FA5] text-left transition-all flex items-center gap-5 group shadow-sm hover:shadow-md"
                  >
                    <div className="w-14 h-14 rounded-xl bg-blue-50 flex items-center justify-center text-[#185FA5] text-2xl group-hover:scale-110 transition-transform">
                      <i className="ti ti-pencil"></i>
                    </div>
                    <span className="font-black text-[16px] text-slate-800 group-hover:text-[#185FA5]">
                      Create Offline Exam
                    </span>
                  </button>
                  ...
                  <button
                    ...
                    className="w-full p-4 rounded-2xl bg-white hover:bg-slate-50 border-2 border-slate-100 hover:border-[#3B6D11] text-left transition-all flex items-center gap-5 group shadow-sm hover:shadow-md"
                  >
                    <div className="w-14 h-14 rounded-xl bg-emerald-50 flex items-center justify-center text-[#3B6D11] text-2xl group-hover:scale-110 transition-transform">
                      <i className="ti ti-school"></i>
                    </div>
                    <span className="font-black text-[16px] text-slate-800 group-hover:text-[#3B6D11]">
                      Mount Test Terminal
                    </span>
                  </button>
                  ...
                  <button
                    ...
                    className="w-full p-4 rounded-2xl bg-white hover:bg-slate-50 border-2 border-slate-100 hover:border-[#854F0B] text-left transition-all flex items-center gap-5 group shadow-sm hover:shadow-md"
                  >
                    <div className="w-14 h-14 rounded-xl bg-amber-50 flex items-center justify-center text-[#854F0B] text-2xl group-hover:scale-110 transition-transform">
                      <i className="ti ti-database"></i>
                    </div>
                    <span className="font-black text-[16px] text-slate-800 group-hover:text-[#854F0B]">
                      Access Local Vault
                    </span>
                  </button>
                </div>
